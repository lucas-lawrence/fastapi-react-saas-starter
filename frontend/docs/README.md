...
These are not architecture decisions (those live in `../../docs/`) but deliberate choices worth recording so they don't get second-guessed or undone later.

## Index

| # | Title |
|---|---|
| [0001](0001-framework-and-ui.md) | Framework and UI library |
| [0002](0002-dark-mode.md) | Dark mode strategy |
